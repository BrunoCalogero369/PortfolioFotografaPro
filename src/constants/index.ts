...
export const PROJECTS: Project[] = [
  ...
  },  
  {
    ...
    description: "Este proyecto ha supuesto un ejercicio de análisis y traducción visual de la arquitectura, entendiendo la fotografía como un medio capaz de revelar las intenciones espaciales del proyecto. La vivienda unifamiliar entre medianeras proyectada por Pablo Muñoz Payá plantea una organización clara y racional donde la luz, el patio interior y la continuidad longitudinal estructuran la experiencia del habitar. La labor fotográfica ha consistido en identificar esos elementos esenciales y potenciarlos mediante decisiones conscientes de encuadre, perspectiva y tratamiento de la imagen. A través de encuadres mayoritariamente verticales y del control riguroso de las líneas, inspirado en el trabajo de David Zarzoso, se ha buscado transmitir claridad formal y equilibrio. En definitiva, la experiencia ha permitido consolidar una metodología de trabajo coherente, donde técnica y concepto se relacionan directamente. La fotografía resultante no solo representa el espacio, sino que construye una lectura intencionada de la arquitectura, reforzando su identidad y su atmósfera.",
    location: "-",
    coverImage: "/trabajo7/07-N7.jpg",
    photos: [
      "/trabajo7/01-N7.jpg",
      "/trabajo7/02-N7.jpg",
      "/trabajo7/03-N7.jpg",
